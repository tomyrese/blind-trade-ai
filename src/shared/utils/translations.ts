...
const translations = {
  vi: {
    ...
    fusion_limit_message: 'Bạn chỉ có thể chọn tối đa 3 thẻ để hợp nhất.',
    fusion_requirement_title: 'Yêu cầu',
    fusion_requirement_message: 'Bạn cần đúng 3 thẻ bài để bắt đầu hợp nhất.',
    no_results_found: 'Không có kết quả nào.',
    fusion_success: 'HỢP NHẤT THÀNH CÔNG!',
    fusion_failed: 'HỢP NHẤT THẤT BẠI!',
    error_rarity_mismatch: 'Các thẻ bài phải có cùng độ hiếm!',
    ...
    master_notifications: 'Nhận thông báo',
    master_notifications_desc: 'Bật/tắt toàn bộ thông báo từ ứng dụng',
    market_alerts: 'Thông báo chợ',
    market_alerts_desc: 'Thông báo khi có thẻ mới được rao bán trên chợ',
    price_alerts_granular: 'Biến động giá',
    price_alerts_desc: 'Thông báo khi giá thẻ Pokémon thay đổi mạnh',
    daily_summary: 'Tóm tắt hằng ngày',
    daily_summary_desc: 'Nhận báo cáo thị trường vào 8:00 sáng mỗi ngày',
    info: 'Thông báo',
    ...
    tab_hot: 'Hot',
    tab_all: 'Tất Cả',
    no_cards_found: 'Không có thẻ bài nào.',
    ...
    forgot_password_desc: 'Hãy nhập email của bạn để thực hiện khôi phục mật khẩu.',
    email_not_found: 'Không tìm thấy tài khoản với email này.',
    reset_password_sent: 'Mã xác thực đã được gửi đến email!',
    enter_recovery_otp: 'Nhập mã xác thực gồm 6 chữ số.',
    new_password_placeholder: 'Nhập mật khẩu mới (tối thiểu 6 ký tự)',
    password_reset_success: 'Đổi mật khẩu thành công! Vui lòng đăng nhập lại.',
    check_email: 'Vui lòng kiểm tra email để nhận mã OTP.',
    verifying_otp: 'Đang xác thực mã OTP...',
    otp_verified: 'Xác thực thành công!',
    invalid_otp: 'Mã OTP không chính xác',
    resend_otp: 'Gửi lại mã',
    otp_sent: 'Đã gửi mã OTP mới',
    time: 'Giờ',
    please_verify_email: 'Vui lòng xác thực email trước.',
    password_placeholder: 'Nhập mật khẩu',
    
    // Validation
    full_name_required: 'Vui lòng nhập họ tên',
    name_no_numbers: 'Tên không được chứa số',
    email_required: 'Vui lòng nhập email',
    invalid_email_format: 'Email không đúng định dạng',
    phone_number: 'Số điện thoại',
    phone_min_10: 'Số điện thoại phải có ít nhất 10 số',
    phone_digits_only: 'Chỉ được nhập chữ số',
    password_required: 'Vui lòng nhập mật khẩu',
    password_min_8: 'Mật khẩu phải từ 8 ký tự',
    password_need_letter: 'Cần ít nhất 1 chữ cái',
    password_need_number: 'Cần ít nhất 1 con số',
    password_need_upper: 'Ít nhất 1 chữ hoa (A-Z)',
    password_need_lower: 'Ít nhất 1 chữ thường (a-z)',
    password_need_special: 'Ít nhất 1 ký tự đặc biệt (!@#...)',
    password_rules_title: 'Yêu cầu mật khẩu:',
    ...
    rarity_rare_holo_vmax: 'Rare Holo VMAX',
    rarity_rare_holo_vstar: 'Rare Holo VSTAR',
    ...
    gacha_tap_to_open: 'CHẠM ĐỂ MỞ THẺ',
    gacha_topup_hint: 'Vui lòng nạp thêm để tiếp tục thực hiện quay thẻ!',
    ...
    back: 'Quay lại',
    transaction_success_msg: 'Giao dịch thành công',
    transaction_failed_msg: 'Giao dịch thất bại',
    buy_pokemon: 'Mua thẻ Pokémon',
    deposit_to_account: 'Nạp tiền vào tài khoản',
    other_transaction: 'Giao dịch khác',
    protected_by: 'Giao dịch này được bảo mật bởi hệ thống Poké-Shield™',
    download_receipt_pdf: 'Tải hóa đơn (PDF)',
    need_help: 'Cần hỗ trợ về giao dịch này?',
    no_transactions: 'Bạn chưa thực hiện giao dịch nào.',
    buy_item: 'Mua hàng',
    failed: 'Thất bại',
    
    // Scanner
    scanner_step1_title: 'Quét Tài Sản',
    scanner_step1_desc: 'AI phân tích hình ảnh và dữ liệu thị trường',
    scanner_step2_title: 'Xác Thực',
    scanner_step2_desc: 'So sánh với database và pattern matching',
    scanner_step3_title: 'Kết Quả',
    scanner_step3_desc: 'Nhận đánh giá chi tiết và độ tin cậy',
    scanner_result_safe: 'Tất cả các chỉ số đều đạt ngưỡng an toàn. Tài sản này đã được xác thực.',
    scanner_result_warning: 'Một số dấu hiệu không khớp với dữ liệu thị trường. Cần xem xét kỹ.',
    scanner_result_danger: 'Phát hiện nhiều dấu hiệu bất thường. Tài sản này có khả năng cao là giả mạo.',
    scanning_loading: 'Đang Quét...',
    start_scanning: 'Bắt Đầu Quét',
    how_it_works: 'Cách Thức Hoạt Động',
    
    // System & Status
    loading_trainer_data: 'Đang tải dữ liệu Trainer...',
    status_filled: 'Hoàn thành',
    status_pending: 'Chờ',
    ...
    enter_otp_6: 'Vui lòng nhập mã OTP 6 số.',
    email_verified: 'Email đã được xác thực!',
    general_settings: 'Cài đặt chung',
    alert_types: 'Loại thông báo',
  },
  en: {
    // Common
    welcome: 'Welcome',
    ...
    fusion_limit_message: 'You can only select up to 3 cards for fusion.',
    fusion_requirement_title: 'Requirement',
    fusion_requirement_message: 'You need exactly 3 cards to start fusion.',
    no_results_found: 'No results found.',
    fusion_success: 'FUSION SUCCESS!',
    fusion_failed: 'FUSION FAILED!',
    error_rarity_mismatch: 'Cards must be of the same rarity!',
    ...
    master_notifications: 'Enable Notifications',
    master_notifications_desc: 'Turn on/off all app notifications',
    market_alerts: 'Market Alerts',
    market_alerts_desc: 'Notify when new cards are listed on market',
    price_alerts_granular: 'Price Alerts',
    price_alerts_desc: 'Notify when Pokémon card prices fluctuate',
    daily_summary: 'Daily Summary',
    daily_summary_desc: 'Receive market reports daily at 8:00 AM',
    info: 'Info',
    ...
    forgot_password_desc: 'Enter your email to receive a password recovery link.',
    email_not_found: 'Account not found with this email.',
    reset_password_sent: 'Verification code sent to your email!',
    enter_recovery_otp: 'Enter the 6-digit verification code.',
    ...
    check_email: 'Please check your email for the OTP code.',
    verifying_otp: 'Verifying OTP code...',
    otp_verified: 'Verification successful!',
    invalid_otp: 'Invalid OTP code',
    resend_otp: 'Resend code',
    otp_sent: 'New OTP code sent',
    time: 'Time',
    ...
    phone_min_10: 'Phone number must be at least 10 digits',
    phone_digits_only: 'Only digits are allowed',
    password_required: 'Please enter your password',
    password_min_8: 'Password must be at least 8 characters',
    password_need_letter: 'Need at least one letter',
    password_need_upper: 'At least one uppercase (A-Z)',
    password_need_lower: 'At least one lowercase (a-z)',
    password_need_number: 'At least one number (0-9)',
    password_need_special: 'At least one special char (!@#...)',
    ...
    gacha_tap_to_open: 'TAP TO REVEAL CARDS',
    gacha_topup_hint: 'Please top up your balance to continue summon.',
    gacha_insufficient_balance: 'Insufficient balance to roll!',
    ...
    back: 'Back',
    transaction_success_msg: 'Transaction successful',
    transaction_failed_msg: 'Transaction failed',
    buy_pokemon: 'Buy Pokémon card',
    deposit_to_account: 'Deposit to account',
    other_transaction: 'Other transaction',
    protected_by: 'This transaction is secured by Poké-Shield™ system',
    ...
    // Scanner
    scanner_step1_title: 'Asset Scan',
    scanner_step1_desc: 'AI analyzes images and market data',
    scanner_step2_title: 'Verification',
    scanner_step2_desc: 'Database comparison and pattern matching',
    scanner_step3_title: 'Results',
    scanner_step3_desc: 'Detailed evaluation and reliability score',
    scanner_result_safe: 'All indicators are safe. This asset is verified.',
    scanner_result_warning: 'Some signs do not match market data. Careful review needed.',
    scanner_result_danger: 'Detected multiple abnormalities. High risk of counterfeit.',
    scanning_loading: 'Scanning...',
    start_scanning: 'Start Scanning',
    how_it_works: 'How It Works',
    
    // System & Status
    loading_trainer_data: 'Loading Trainer data...',
    ...
    enter_otp_6: 'Please enter 6-digit OTP code.',
